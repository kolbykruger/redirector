<template>
    <div class="partial-match-link" v-if="!confirmed">
                    ...
                    <PartialMatchOptionLink
                        ...
                        :class="{
                            'link-selected': isSelected(
                                redirectData.new[0].link
                            )
                        }"
                        :title="
                            redirectData.new[0].similarities.length +
                                ' similarities of ' +
                                redirectData.new[0].total +
                                ' words - ' +
                                redirectData.new[0].probability +
                                '% probability'
                        "
        ...
        <div class="tray buttons">
            <button class="button button-green button-small" @click="confirm">
                + Create
            </button>
            <button
